...
enum _VIW_ID_ErrorID
{
    ...
    _VIW_ID_ERRORID_FINDBASE_NOBASE = 0x200170200,
    _VIW_ID_ERRORID_UPDATESCRIPTTIME_OWNSCRIPT = 0x200180200,
    _VIW_ID_ERRORID_FINDNEXTBASE_ROOT = 0x200190100,
    _VIW_ID_ERRORID_FINDNEXTBASE_NOBASE = 0x200190201,
    _VIW_ID_ERRORID_CREATEBASEVIEW_VIEW = 0x2001A0200,
    _VIW_ID_ERRORID_CREATEBASEVIEW_PROPERTY = 0x2001A0201,
    _VIW_ID_ERRORID_CREATEBASEVIEW_ORDERSCRIPT = 0x2001A0202,
    _VIW_ID_ERRORID_CREATESUBVIEW_NEXTBASE = 0x2001B0200,
    _VIW_ID_ERRORID_CREATESUBVIEW_VIEW = 0x2001B0201,
    _VIW_ID_ERRORID_CREATESUBVIEW_BASE = 0x2001B0202,
    _VIW_ID_ERRORID_DESTROYVIEW_REMOVEFROMLIST = 0x2001C0100,
    _VIW_ID_ERRORID_UPDATEACTIVE_PROPERTY = 0x2001D0200,
    _VIW_ID_ERRORID_UPDATEACTIVE_CHILD = 0x2001D0201,
    _VIW_ID_ERRORID_CHANGEACTIVESET_UPDATE = 0x2001E0200,
    _VIW_ID_ERRORID_CHANGEACTIVE_UPDATE = 0x2001F0200
};
