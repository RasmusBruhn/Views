...
enum _VIW_Core_ID_ErrorID
{
    ...
    _VIW_ID_ERRORID_FINDREFVIEW_SAMEPARENT = 0x200070203,
    _VIW_ID_ERRORID_FINDREFVIEW_CHILDPOS = 0x200070204,
    ...
    _VIW_ID_ERRORID_CREATEPROPERTYBASE_EXISTS = 0x200100205,
    ...
    _VIW_ID_ERRORID_ADDREF_PARENT = 0x200120203,
    _VIW_ID_ERRORID_ADDREF_EARLYCHILD = 0x200120204,
    _VIW_ID_ERRORID_ADDREF_BASE = 0x200120205,
    _VIW_ID_ERRORID_USEADVANCEDSHAPEDATA_MALLOC = 0x200130200,
    _VIW_ID_ERRORID_USEADVANCEDSHAPEDATA_INIT = 0x200130101,
    _VIW_ID_ERRORID_USEADVANCEDSHAPEDATA_BASE = 0x200130202,
    ...
    _VIW_ID_ERRORID_SETBASEORIGIN_BASE = 0x200220200,
    _VIW_ID_ERRORID_ADDBASEORIGIN_BASE = 0x200230200
};
...
#define _VIW_STRING_ERROR_SAMEPARENT "A view and its reference must be siblings"
#define _VIW_STRING_ERROR_EARLYCHILD "The reference view must be a earlier child"
#define _VIW_STRING_ERROR_BASEPARENT "The parent of a view must be the base"
#define _VIW_STRING_ERROR_BASE "The base is not a base"
#define _VIW_STRING_ERROR_ALREADYPROPERTY "A view can only have one property"
